...
function createClient(params, opts = {}) {
  ...
  `${sdkMain}/${"7.53.0"}`, params.application, params.integration, params.feature);
...
function createEntryApi(makeRequest) {
  ...
  const _entities$comment = _entities__WEBPACK_IMPORTED_MODULE_1__["default"].comment,
...
function createEnvironmentApi(makeRequest) {
  ...
  const wrapAppSignedRequest = _entities__WEBPACK_IMPORTED_MODULE_1__["default"].appSignedRequest.wrapAppSignedRequest;
  const wrapAppActionCall = _entities__WEBPACK_IMPORTED_MODULE_1__["default"].appActionCall.wrapAppActionCall;
...
function createOrganizationApi(makeRequest) {
  ...
  const wrapAppSigningSecret = _entities__WEBPACK_IMPORTED_MODULE_1__["default"].appSigningSecret.wrapAppSigningSecret;
  const wrapAppDetails = _entities__WEBPACK_IMPORTED_MODULE_1__["default"].appDetails.wrapAppDetails;
  const _entities$appAction = _entities__WEBPACK_IMPORTED_MODULE_1__["default"].appAction,
...
function wrapAppActionCall(_makeRequest, data) {
  const signedRequest = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(Object(fast_copy__WEBPACK_IMPORTED_MODULE_0__["default"])(data));
 ...
 * @private
 */
const createPlainClient = (makeRequest, defaults, alphaFeatures) => {
  const wrapParams = {
    makeRequest,
    defaults
  };
  return _objectSpread({
    ...
    contentType: {
      ...
      omitAndDeleteField: (params, contentType, fieldId) => Object(_methods_content_type__WEBPACK_IMPORTED_MODULE_1__["omitAndDeleteField"])(makeRequest, _objectSpread(_objectSpread({}, _objectSpread(_objectSpread({}, defaults), params)), {}, {
        fieldId
      }), contentType)
    },
    user: {
