...
function _ref() {
  _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(options) {
    var configFile, environment, tokenOption, watch, quiet, previewMode, cmaBaseUrl, pageSize, token, headers, client, loader, unwatch;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 18:
            ...
            throw new Error("Missing config file ".concat(configFile, "\n"));
