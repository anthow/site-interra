...
function command(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
  return _command.apply(this, arguments);
}

function _command() {
  _command = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(token, environment, wpUrl, wpUser, wpPassword, cmaBaseUrl, wpApiEndpointUrl) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 26:
            ...
            _context.next = 29;
            return (0, _articles["default"])(dato, wp, schema, media, categories, tags, authors);
