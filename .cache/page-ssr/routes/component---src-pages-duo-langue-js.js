"use strict";
exports.id = "component---src-pages-duo-langue-js";
exports.ids = ["component---src-pages-duo-langue-js"];
exports.modules = {
...
const Duopage = ({
  ...
  className: "md:w-10/12  mt-2   m-auto"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", {
  className: "font-black text-4xl mb-10 md:mb-20 text-vert-interra  bg-white text-center"
}, " ", data.datoCmsDuoLangue.titre), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("section", {
  className: "md:grid grid-cols-2  gap-x-10 gap-y-20"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("video", {
  controls: true,
  className: "w-full px-10 mb-10 md:mb-0"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("source", {
  src: data.datoCmsDuoLangue.videoKSako.video.mp4Url,
  type: "video/mp4"
})), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  className: "w-10/12 md:w-12/12 m-auto"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", {
  className: "font-black text-2xl mb-5 text-orange-interra "
}, " ", data.datoCmsDuoLangue.titreKSako), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  dangerouslySetInnerHTML: {
    __html: data.datoCmsDuoLangue.texteKSako
  },
  className: "mb-10"
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", {
  className: "font-black text-2xl mb-5 text-orange-interra "
}, " ", data.datoCmsDuoLangue.titrePourQui), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  dangerouslySetInnerHTML: {
    __html: data.datoCmsDuoLangue.textePourQui
  },
  className: ""
}))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", {
  className: "font-black w-10/12 md:w-12/12 m-auto  text-3xl md:text-4xl my-10 md:my-20 text-vert-interra  bg-white text-center"
}, " ", data.datoCmsDuoLangue.titreRoleInterra), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("section", {
  className: "md:grid grid-cols-2 flex flex-col  md:gap-y-20 mb-20"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  dangerouslySetInnerHTML: {
    __html: data.datoCmsDuoLangue.listeRoleInterra
  },
  className: "bg-vert-interra text-white p-5 font-black list-duo order-2 md:order-1"
  ...
  image: data.datoCmsDuoLangue.imageRoleInterra.gatsbyImageData,
  alt: data.datoCmsDuoLangue.imageRoleInterra.alt,
  className: "h-full order-1 md:order-2 "
}))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("section", {
  className: "md:grid grid-cols-2  gap-x-10 gap-y-10 md:gap-y-20  w-10/12 m-auto"
  ...
  className: "font-black text-2xl mb-5 text-orange-interra "
}, " ", data.datoCmsDuoLangue.titreVotreImplication), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  dangerouslySetInnerHTML: {
    __html: data.datoCmsDuoLangue.texteVotreImplication
  },
  className: ""
})), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  ...
  className: "font-black text-2xl mb-5 text-orange-interra "
}, " ", data.datoCmsDuoLangue.titreFinDImplication), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  dangerouslySetInnerHTML: {
    __html: data.datoCmsDuoLangue.texteFinDImplication
  },
  className: ""
}))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", {
  className: "mt-10 w-10/12 md:w-12/12 m-auto flex items-center space-x-2"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", {
  className: "text-orange-interra font-black"
}, "Outil de communication : "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_3__.StaticImage, {
  src: "../../../images/whatsapp.png",
  width: 40,
  quality: 95,
  formats: ["auto", "webp", "avif"],
...
;
//# sourceMappingURL=component---src-pages-duo-langue-js.js.map