"use strict";
exports.id = "component---src-pages-presse-js";
exports.ids = ["component---src-pages-presse-js"];
exports.modules = {
...
const Presse = ({
  ...
  className: "font-black text-4xl  text-vert-interra mt-2  bg-white text-center mb-20"
}, " Presse "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("section", {
  className: " w-10/12 md:w-7/12 flex flex-col mb-20  md:space-x-10 m-auto space-y-40 content-start "
}, data.allDatoCmsPresse.edges.map(({
  node
}) => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "flex flex-col md:grid  grid-cols-2 space-x-10   w-12/12 "
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("figure", {
    className: "m-auto  "
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_4__.GatsbyImage, {
    image: node.logoMedia.gatsbyImageData,
    alt: node.logoMedia.alt,
    className: " mb-10  m-auto md:justify-self-center   "
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: " "
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", {
    className: "font-black text-m  text-orange-interra "
  }, " ", node.nomDuMDia, " "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", {
    className: "font-black text-lg mt-4 text-vert-interra italic mb-2 "
  }, " ", node.nomDeLArticle, " "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    dangerouslySetInnerHTML: {
      __html: node.extrait
    },
    className: " italic mb-10"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", {
    href: node.urlArticle,
    rel: "noreferrer",
    target: "_blank",
    className: "mt-10 text-center"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
    className: " md:mb-0 text-white bg-orange-interra font-black  p-1 px-2  rounded hover:bg-white-interra hover:text-orange-interra hover:bg-white border hover:border-orange-interra"
  }, " lire l'article "))));
}))));

const query = "1489410872";
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Presse);
...
;
//# sourceMappingURL=component---src-pages-presse-js.js.map