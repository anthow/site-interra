         ...
         flex-col md:flex-row md:space-x-2"
          >
            ...
            <li className="flex flex-row md:mr-2 gap-2 items-center">
              ...
              <GatsbyImage image={data.datoCmsMenu.imageWallonie.gatsbyImageData} alt={data.datoCmsMenu.imageWallonie.alt} />
