...
const devenirBenevole = ({ data }) => (
    <Layout className="">
        ...
        <div className="mt-10 w-12/12">
            ...
            <form action="https://formspree.io/f/mnqrrkoa" method="post" className="flex flex-col gap-5">
...
<fieldset className="flex flex-col  gap-2">
    <legend className=" mb-2 text-lg">Je suis:</legend>

    <div>
      <input type="radio" id="primo-arrivante" name="jesuis" value="primo-arrivante" className="mr-2"
             />
