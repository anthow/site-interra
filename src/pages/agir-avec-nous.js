...
const Duopage = ({ data }) => (
        <Layout className="">
                ...
                <div className="w-12/12">
                        <h1 className="font-black  text-4xl md:-mb-20  text-vert-interra  bg-white text-center" id="Talent" >
                                Agir avec nous </h1>
                        ...
                        <article className="md:w-8/12  flex flex-col  md:space-y-40   m-auto">
                                ...
                                <section className=" bg-orange-interra  flex flex-col md:flex-row  justify-around" >
                                        <figure className="h-max">
                                                <GatsbyImage image={data.datoCmsAgirAvecNou.imageMembre.gatsbyImageData}
                                                        alt={data.datoCmsAgirAvecNou.imageMembre.alt} className=" min-h-full justify-self-end      " />
                                        </figure>
                                        ...
                                        <div className="p-10 flex-grow-0 ">
                                                ...
                                                <Link to="/devenir-membre">
                                                        ...
                                                        <button id="" className="mt-10 bg-white text-orange-interra font-black p-2 hover:opacity-90"> Devenir Talent </button>
                                                </Link>
                                        </div>
                                ...
                                <section className=" bg-vert-interra  flex flex-col md:flex-row  justify-around" id="">
                                        ...
                                        <GatsbyImage image={data.datoCmsAgirAvecNou.imageDuoLange.gatsbyImageData}
                                                alt={data.datoCmsAgirAvecNou.imageDuoLange.alt} className="h-full order-1 md:order-2 justify-self-end      " />
                                ...
                                <section className=" bg-orange-interra  flex flex-col md:flex-row  justify-around" id="">
                                        <GatsbyImage image={data.datoCmsAgirAvecNou.imageTalent.gatsbyImageData}
                                                alt={data.datoCmsAgirAvecNou.imageTalent.alt} className="h-full  justify-self-end      " />
                                        ...
                                        <div className="p-10 flex-grow-0 ">
                                                ...
                                                <Link to="/devenir-talent-interra">
                                                        ...
                                                        <button className="mt-10 bg-white text-orange-interra font-black p-2 hover:opacity-90">   Devenir coach pour l'InterLab  </button>
                                                </Link>
                                        </div>
...
<section className=" bg-vert-interra  flex flex-col md:flex-row  justify-around" >
        ...
        <div className="p-10 order-2 md:order-1  flex-grow-0 ">
                <h2 className=" mb-2 mb-10 text-white font-black text-3xl"> {data.datoCmsAgirAvecNou.titreParticiperFormation} </h2>
                <div dangerouslySetInnerHTML={{ __html: data.datoCmsAgirAvecNou.texteParticiperFormation }} ></div>
                <Link to="/devenir-benevole">

                        <button className="mt-10 bg-white text-vert-interra font-black p-2 hover:opacity-90"> Participer à une formation </button>
                </Link>
        </div>

        <GatsbyImage image={data.datoCmsAgirAvecNou.imageParticiperFormation.gatsbyImageData} alt={data.datoCmsAgirAvecNou.imageBNVole.alt}
...
{/*.............................................................................................................................*/}
                                ...
                                <section className=" bg-orange-interra  flex flex-col md:flex-row  justify-around" >
                                <GatsbyImage image={data.datoCmsAgirAvecNou.imageBNVole.gatsbyImageData} alt={data.datoCmsAgirAvecNou.imageBNVole.alt}
                                        ...
                                        <div className="p-10 order-2 md:order-1  flex-grow-0 ">
                                                ...
                                                <Link to="/devenir-benevole">
                                                        ...
                                                        <button className="mt-10 bg-white text-orange-interra font-black p-2 hover:opacity-90"> Devenir Volontaire </button>
                                                </Link>
                                        </div>
                                ...
                                <section className=" bg-vert-interra  flex flex-col md:flex-row  justify-around">
                                        ...
                                        <GatsbyImage image={data.datoCmsAgirAvecNou.imageDon.gatsbyImageData}
