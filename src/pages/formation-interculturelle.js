    ...
    <Layout className="">
        ...
        <div className="w-12/12">
            <article className="w-10/12 mt-2  m-auto">
                <h1 className="font-black text-4xl mb-10 md:mb-20 text-bleu-interra  text-center"> {data.datoCmsFormationInterculturelle.titre}</h1>
                <section className="md:grid grid-cols-2 mb-10 flex flex-col gap-x-10 gap-y-10 md:gap-y-20">
                    ...
                    <div>
                        <h2 className="font-black text-2xl mb-5 text-bleu-interra "> {data.datoCmsFormationInterculturelle.titreOrganiser}</h2>
                ...
                <button className=" mt-5 text-white font-black  p-1 px-2  bg-bleu-interra hover:opacity-80 rounded">
